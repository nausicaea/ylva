...
@dataclass
class CategoriesList(DataClassDictMixin):
    category_groups: List[CategoryGroup]
    server_knowledge: int


@dataclass
class CategoriesResponse(ResponseWrapper[CategoriesList], DataClassJSONMixin):
    pass
...
@dataclass
class ListCategories(ApiEndpoint):
    budget_id: str
    ...
    def path(self) -> str:
        return f"/v1/budgets/{self.budget_id}/categories"

    def response_data_type(self) -> Type[CategoriesResponse]:
